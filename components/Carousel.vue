    ...
    <div class="card-carousel" @mouseover="stopTimer" @mouseleave="restartTimer">
        ...
        <div class="card-img">
          <v-lazy-image
            ...
            :src-placeholder="require(`~/assets/images/${ currentImage }.png`)"
            alt="Pattern Recognition slide"
            use-picture>
            <source :srcset="require(`~/assets/images/${ currentImage }.webp`)"
                    type="image/webp" />
          </v-lazy-image>
            <div class="actions">
        ...
        <div class="thumbnails">
            <div v-for="(image, index) in images"
                ...
                <v-lazy-image
                  :src="require(`~/assets/images/${image.thumb}@0.1x.jpg`)"
                  alt="Pattern Recognition thumbnail"
                  use-picture>
                  <source :srcset="require(`~/assets/images/${ image.thumb }@0.1x.webp`)"
                          type="image/webp" />
                </v-lazy-image>
            </div>
        </div>
